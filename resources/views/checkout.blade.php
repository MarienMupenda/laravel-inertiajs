                ...
                <div class="mt-8">
                    ...
                    <div class="flex mt-6">
                        <label class="block w-3/12">
                            <select class="block w-full mt-1 border-gray-300 rounded-md shadow-sm focus:border-blue-300 focus:ring focus:ring-blue-200 focus:ring-opacity-50">
                                <option>NY</option>
                                <option>DC</option>
                                <option>MH</option>
                                <option>MD</option>
                        ...
                        <label class="flex-1 block ml-3">
                            <input type="text" class="block w-full mt-1 border-gray-300 rounded-md shadow-sm focus:border-blue-300 focus:ring focus:ring-blue-200 focus:ring-opacity-50" placeholder="Address">
                        </label>
                    </div>
                </div>
                <div class="mt-8">
                    ...
                    <div class="flex mt-6">
                        <label class="flex-1 block">
                            <input type="date" class="block w-full mt-1 border-gray-300 rounded-md shadow-sm focus:border-blue-300 focus:ring focus:ring-blue-200 focus:ring-opacity-50" placeholder="Date">
                        </label>
                    </div>
                </div>

    ...
    <div class="container px-6 py-3 mx-auto">
        <div class="flex items-center justify-between">
            <div class="hidden w-full text-gray-600 md:flex md:items-center">
                ...
                <span class="mx-1 text-sm">Lubumbashi</span>
            </div>
            <div class="w-full text-2xl font-semibold text-gray-700 uppercase md:text-center">
                {{ config('app.name') }}
            </div>
            <div class="flex items-center justify-end w-full">
                <a href="{{route('dashboard')}}" class="mx-4 text-gray-600 focus:outline-none sm:mx-0">
                    <i class="w-5 h-5 fa fa-store"></i>

                </a>

                <button hidden @click="cartOpen = !cartOpen" class="mx-4 text-gray-600 focus:outline-none sm:mx-0">
        ...
        <nav :class="isOpen ? '' : 'hidden'" class="mt-4 sm:flex sm:justify-center sm:items-center">
            <div class="flex flex-col sm:flex-row">
                <a class="mt-3 text-gray-600 hover:underline sm:mx-3 sm:mt-0" href="{{route('home')}}">{{ __('Home') }}</a>
                ...
                <a class="mt-3 text-gray-600 hover:underline sm:mx-3 sm:mt-0" href="#">#MadeInCongo</a>
                <a class="mt-3 text-gray-600 hover:underline sm:mx-3 sm:mt-0" href="#">Contact</a>
                <a class="mt-3 text-gray-600 hover:underline sm:mx-3 sm:mt-0" href="#">About</a>
            </div>
        </nav>
        <div hidden class="relative max-w-lg mx-auto mt-6">
            ...
            <input class="block w-full pl-10 border-gray-300 rounded-md shadow-sm focus:border-purple-300 focus:ring focus:ring-purple-200 focus:ring-opacity-50" type="text" placeholder="Search">
        </div>
    </div>
</header>
